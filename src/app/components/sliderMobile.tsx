...
const items = [
  ...
  { id: 5, title: "Donate Your Zakat", target: "https://pennyappeal.ca/about/team-orange/", image: "https://pennyappeal.ca/wp-content/uploads/2024/03/fow9new.jpg" },
...
interface CardProps {
  ...
  const Card: React.FC<CardProps> = ({ image, title, target }) => (
    <Link href={target}>
      <div
        className="max-w-sm p-7 mx-2 my-5 pt-20 min-w-[21vw] w-[45vw] h-[200px] border-gray-200 rounded-xl shadow-none shadow-slate-50 dark:bg-gray-800 dark:border-gray-700 opacity-95 relative bg-cover bg-center transition-all duration-300 hover:shadow-xl hover:shadow-[0px_0px_0px_5px_#ffffff] hover:scale-[103%]"
